...
export class TypeOrmStationRepository implements StationRepository {
  ...
  private toPersistence(station: Station): Partial<StationEntity> {
    return {
      ...
      endId: station.endId,
      elementType: station.elementType ?? undefined,
      technology: station.technology ?? undefined,
      areaHolder: station.areaHolder ?? undefined,
      infraContractType: station.infraContractType ?? undefined,
      infraHolder: station.infraHolder ?? undefined,
      infraType: station.infraType ?? undefined,
      evType: station.evType ?? undefined,
      evSupplier: station.evSupplier ?? undefined,
      address: station.address ?? undefined,
      regional: station.regional ?? undefined,
      latitude: station.latitude ?? undefined,
      longitude: station.longitude ?? undefined,
      mobileCarrier: station.mobileCarrier ?? undefined,
      towerType: station.towerType ?? undefined,
      nominalAev: station.nominalAev ?? undefined,
      groundArea: station.groundArea ?? undefined,
      structureHeight: station.structureHeight ?? undefined,
